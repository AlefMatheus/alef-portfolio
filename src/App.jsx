...
function SectionIntro({ label, title, text }) {
  return (
    <m.div className={sectionIntroClass} {...fadeUp}>
    ...
    <LazyMotion features={domAnimation}>
      ...
      <main>
        ...
        <section className="mx-auto grid max-w-7xl gap-4 pb-8 md:grid-cols-[minmax(0,1fr)_auto] md:items-center md:pb-16">
          <m.p className="max-w-2xl text-sm leading-7 text-muted sm:text-base" {...fadeUp}>
            Solucoes pensadas para transformar ideia em produto claro, rapido e pronto para
            gerar resultado.
          </m.p>
          <m.div className="flex flex-wrap gap-3" {...fadeUp}>
        ...
        <section className="mx-auto max-w-7xl py-10 sm:py-14 lg:py-20" id="processo">
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,0.8fr)]">
            <m.div className="grid gap-4" {...fadeUp}>
        ...
        <section className="mx-auto max-w-7xl py-10 sm:py-14 lg:py-20" id="contato">
          <m.div className={`${surfaceClass} grid gap-5 rounded-[2rem] p-6 sm:p-8`} {...fadeUp}>
      ...
      <a
        className="fixed bottom-24 right-4 z-40 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25d366] text-white shadow-[0_16px_34px_rgba(37,211,102,0.28)] transition hover:-translate-y-1 sm:h-16 sm:w-16 lg:bottom-5"
        href={whatsappLink}
        target="_blank"
        rel="noreferrer"
